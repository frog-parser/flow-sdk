...
public class StrTrimFunctionCommand extends AbstractFunctionCommand {
    ...
    public StrTrimFunctionCommand setParameter(FlowVariable parameter) {
    ...
    public StrTrimFunctionCommand setResult(FlowVariable result) {
        this.result = result;
        return this;
    }
}
