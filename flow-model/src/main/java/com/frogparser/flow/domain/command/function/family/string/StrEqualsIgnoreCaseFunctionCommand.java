...
public class StrEqualsIgnoreCaseFunctionCommand extends AbstractFunctionCommand {
    ...
    public StrEqualsIgnoreCaseFunctionCommand setParameterOne(FlowVariable parameterOne) {
    ...
    public StrEqualsIgnoreCaseFunctionCommand setParameterTwo(FlowVariable parameterTwo) {
    ...
    public StrEqualsIgnoreCaseFunctionCommand setResult(FlowVariable result) {
        this.result = result;
        return this;
    }
}
