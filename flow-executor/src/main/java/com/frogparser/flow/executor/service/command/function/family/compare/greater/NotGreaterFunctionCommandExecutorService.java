package com.frogparser.flow.executor.service.command.function.family.compare.greater;
...
@Service
public class NotGreaterFunctionCommandExecutorService extends AbstractCommandExecutorService<NotGreaterFunctionCommand> {
    @Override
    public void execute(FlowExecutionSettings flowExecutionSettings, FlowContext flowContext, NotGreaterFunctionCommand command) throws CommandExecutionException {
