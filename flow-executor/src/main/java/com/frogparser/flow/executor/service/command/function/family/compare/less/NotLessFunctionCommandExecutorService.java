...
@Service
public class NotLessFunctionCommandExecutorService extends AbstractCommandExecutorService<NotLessFunctionCommand> {
    @Override
    public void execute(FlowExecutionSettings flowExecutionSettings, FlowContext flowContext, NotLessFunctionCommand command) throws CommandExecutionException {
