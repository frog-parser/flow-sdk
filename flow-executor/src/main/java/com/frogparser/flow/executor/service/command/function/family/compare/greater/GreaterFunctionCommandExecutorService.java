...
@Service
public class GreaterFunctionCommandExecutorService extends AbstractCommandExecutorService<GreaterFunctionCommand> {
    @Override
    public void execute(FlowExecutionSettings flowExecutionSettings, FlowContext flowContext, GreaterFunctionCommand command) throws CommandExecutionException {
