...
@Service
public class LessOrEqualsFunctionCommandExecutorService extends AbstractCommandExecutorService<LessOrEqualsFunctionCommand> {
    @Override
    public void execute(FlowExecutionSettings flowExecutionSettings, FlowContext flowContext, LessOrEqualsFunctionCommand command) throws CommandExecutionException {
