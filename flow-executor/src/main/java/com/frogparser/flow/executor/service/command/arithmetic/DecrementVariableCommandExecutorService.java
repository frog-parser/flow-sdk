...
@Service
public class DecrementVariableCommandExecutorService extends AbstractCommandExecutorService<DecrementVariableCommand> {

    private static final Logger log = LoggerFactory.getLogger(DecrementVariableCommandExecutorService.class);

    @Override
    public void execute(FlowExecutionSettings flowExecutionSettings, FlowContext flowContext, DecrementVariableCommand command) throws CommandExecutionException {
