...
@Service
public class GreaterOrEqualsFunctionCommandExecutorService extends AbstractCommandExecutorService<GreaterOrEqualsFunctionCommand> {
    @Override
    public void execute(FlowExecutionSettings flowExecutionSettings, FlowContext flowContext, GreaterOrEqualsFunctionCommand command) throws CommandExecutionException {
